...
@section('content')
    ...
    <div class="box box-default">
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-12">
                    {!! Form::open(array('action' => 'CareerController@update','method'=>'post','files' => true)) !!}
                    {!! Form::hidden('career_id',$career->career_id) !!}
                    <div class="form-group">
                        {!! Form::label('Позиция') !!}
                        {!! Form::text('career_position',@$career->career_position, array('class' => 'form-control')) !!}
                    ...
                    <div class="form-group">
                        {!! Form::label('Описание') !!}
                        {!! Form::textarea('career_description',@$career->career_description, array('class' => 'form-control', 'id' => 'editor')) !!}
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::textarea('career_requirements',@$career->career_requirements, array('class' => 'form-control', 'id' => 'editor1')) !!}
